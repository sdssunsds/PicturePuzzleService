#ifndef _YOLO_LAYER_H_v6
#define _YOLO_LAYER_H_v6
...
namespace nvinfer1
{
    class YoloLayerPlugin_v6 : public IPluginV2IOExt
    {
    public:
        YoloLayerPlugin_v6(int classCount, int netWidth, int netHeight, int maxOut, const std::vector<Yolo_v6::YoloKernel>& vYoloKernel);
        YoloLayerPlugin_v6(const void* data, size_t length);
        ~YoloLayerPlugin_v6();
    ...
    private:
        ...
        int mMaxOutObject;
        std::vector<Yolo_v6::YoloKernel> mYoloKernel;
        void** mAnchor;
    };

    class YoloPluginCreator_v6 : public IPluginCreator
    {
    public:
        YoloPluginCreator_v6();

        ~YoloPluginCreator_v6() override = default;
    ...
    REGISTER_TENSORRT_PLUGIN(YoloPluginCreator_v6);
};

#endif  // _YOLO_LAYER_H_v6
